...
import * as fflate from 'super-three/examples/jsm/libs/fflate.module.js';
import { NURBSCurve } from 'super-three/examples/jsm/curves/NURBSCurve.js';
...
function convertArrayBufferToString( buffer, from, to ) {
	...
	if ( to === undefined ) to = buffer.byteLength || buffer.length;
	console.log(from, to)
