(() => {
    ...
    parse(e) {
      const n = function (t, e) {
        ...
        r = function (t, e, n) {
          ...
          let r = t.pos,
            ...
            s = String.fromCharCode.apply(
              null,
              new Uint16Array(t.subarray(r, r + 128))
            );
          for (; 0 > (a = s.indexOf("\n")) && o < e && r < t.byteLength; )
            (i += s),
              (o += s.length),
          ...
          return (
            -1 < a && (!1 !== n && (t.pos += o + a + 1), i + s.slice(0, a))
          );
        },
        a = function (t, e, n, r) {
          const a = t[e + 3],
        ...
        o = function (e, n, r, a) {
          ...
          (r[a + 0] = t.DataUtils.toHalfFloat(Math.min(e[n + 0] * i, 65504))),
            (r[a + 1] = t.DataUtils.toHalfFloat(Math.min(e[n + 1] * i, 65504))),
            (r[a + 2] = t.DataUtils.toHalfFloat(Math.min(e[n + 2] * i, 65504))),
            (r[a + 3] = t.DataUtils.toHalfFloat(1));
        },
        i = new Uint8Array(e);
      i.pos = 0;
      const s = (function (t) {
        ...
        let c, l;
        if (t.pos >= t.byteLength || !(c = r(t)))
          return n(1, "no header found");
        ...
        for (
          ...
          if (((s.string += c + "\n"), "#" !== c.charAt(0))) {
            if (
              ((l = c.match(e)) && (s.gamma = parseFloat(l[1])),
              (l = c.match(a)) && (s.exposure = parseFloat(l[1])),
              (l = c.match(o)) && ((s.valid |= 2), (s.format = l[1])),
              (l = c.match(i)) &&
                ((s.valid |= 4),
        ...
        return 2 & s.valid
          ? 4 & s.valid
            ? s
            : n(3, "missing image size specifier")
          : n(3, "missing format specifier");
      })(i);
      if (-1 !== s) {
        const e = s.width,
          r = s.height,
          c = (function (t, e, r) {
            const a = e;
            if (a < 8 || a > 32767 || 2 !== t[0] || 2 !== t[1] || 128 & t[2])
            ...
            for (; u > 0 && s < t.byteLength; ) {
              ...
              if (
                ...
                return n(3, "bad rgbe scanline format");
              let e,
                r = 0;
              for (; r < c && s < t.byteLength; ) {
                e = t[s++];
                const a = e > 128;
                if ((a && (e -= 128), 0 === e || r + e > c))
                  return n(3, "bad scanline data");
                if (a) {
                  const n = t[s++];
      ...
      return super.load(
        ...
        function (e, r) {
          switch (e.type) {
            case t.FloatType:
            case t.HalfFloatType:
              (e.colorSpace = t.LinearSRGBColorSpace),
                (e.minFilter = t.LinearFilter),
                (e.magFilter = t.LinearFilter),
                (e.generateMipmaps = !1),
                (e.flipY = !0);
          }
          n && n(e, r);
  ...
  class n extends t.Mesh {
    constructor(e, n = {}) {
      const r =
          [e.isCubeTexture ? "#define ENVMAP_TYPE_CUBE" : ""].join("\n") +
        ...
        a = {
          map: { value: e },
          height: { value: n.height || 15 },
          radius: { value: n.radius || 100 },
        };
      super(
        new t.IcosahedronGeometry(1, 16),
  ...
  AFRAME.registerComponent("ground-projected-skybox", {
    schema: { envMapUrl: { default: "" }, scale: { default: 100 } },
    ...
    createSkybox: async function (t) {
      const r = new e();
      return (
        (this.envMap = await r.loadAsync(t)),
    ...
    cleanup() {
      const t = this.el.sceneEl.object3D;
      this.skybox && t.remove(this.skybox),
        this.envMap && ((t.environment = null), this.envMap.dispose());
    },
    remove: function () {
      this.cleanup();
    },
