...
Ground Projected Skybox ([three counterpart](https://github.com/mrdoob/three.js/blob/dev/examples/jsm/objects/GroundProjectedSkybox.js)):
------
...
|-----------|---------|-----------------------------|
| envMapUrl |    ""   | url to the envmap           |
| scale     |   100   | groundProjectedSkybox scale |


Usage ([live example](https://gftruj.github.io/webzamples/aframe/three-components/examples/ground-projected-skybox-basic.html)):
```html
