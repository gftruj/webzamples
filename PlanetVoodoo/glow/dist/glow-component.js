...
const component = AFRAME.registerComponent("glow", {
  ...
  init: function () {
    ...
    this.glowMaterial = new THREE.ShaderMaterial({
      uniforms: {
        intensityBase: {
          type: "f",
          value: this.data.intensityBase
        },
        intensityPower: {
          type: "f",
          value: this.data.intensityPower
        },
        glowColor: {
          type: "c",
          value: glowColor
  ...
  tick: function (t, dt) {
    ...
    if (this.el.sceneEl.camera) {
      const cameraRig = this.el.sceneEl.camera.el.object3D; // (TODO) update only if there are position changes
...
},{"../lib/BufferGeometryUtils.js":1}]},{},[2]);
